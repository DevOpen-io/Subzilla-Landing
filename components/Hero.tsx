        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-12">
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              href="#install"
              className="flex items-center justify-center gap-2 px-8 py-4 bg-blue-600 text-white rounded-full font-bold shadow-lg shadow-blue-600/30 hover:bg-blue-700 transition-all"
            >
              <Download size={20} />
              {t('hero_btn_download')}
            </motion.a>
